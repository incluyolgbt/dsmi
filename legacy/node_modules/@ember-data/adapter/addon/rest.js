import { A as Adapter, _ as _applyDecoratedDescriptor } from "./index-f54121ea";
import { macroCondition, getOwnConfig } from '@embroider/macros';
import { getOwner } from '@ember/application';
import { assert, warn } from '@ember/debug';
import { computed } from '@ember/object';
import { b as serializeIntoHash, d as determineBodyPromise, g as getFetchFunction, s as serializeQueryParams, p as parseResponseHeaders } from "./serialize-into-hash-b9092b25";
import { B as BuildURLMixin } from "./build-url-mixin-18db8c8b";
import AdapterError, { InvalidError, ServerError, ConflictError, NotFoundError, ForbiddenError, UnauthorizedError, TimeoutError, AbortError } from "./error";
var _dec, _class;
/**
...
let RESTAdapter = (_dec = computed(), (_class = class RESTAdapter extends Adapter.extend(BuildURLMixin) {
  ...
  */
  async ajax(url, type, options = {}) {
    ...
    if (this.useFetch) {
      let hash = this.ajaxOptions(url, type, options);
  ...
  */
  ...
  _fetchRequest(options) {
    let fetchFunction = getFetchFunction();
...
export { RESTAdapter as default, fetchOptions };