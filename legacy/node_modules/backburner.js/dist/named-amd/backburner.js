define('backburner', ['exports'], function (exports) { 'use strict';
    ...
    function buildNext(flush) {
        ...
        if (typeof Promise === 'function') {
            ...
            return function () { return autorunPromise.then(flush); };
        }
            ...
            return function () { return SET_TIMEOUT(flush, 0); };
        }
    }
    ...
    var Backburner = function Backburner(queueNames, options) {
          ...
          this._boundAutorunEnd = function () {
              ...
              if (this$1._autorun === false) {
                  return;
              }
              this$1._autorun = false;
              this$1._autorunStack = null;
      ...
      Backburner.prototype.getDebugInfo = function getDebugInfo () {
          ...
          if (this.DEBUG) {
              return {
                  ...
                  instanceStack: [this.currentInstance ].concat( this.instanceStack)
                      .map(function (deferredActionQueue) { return deferredActionQueue && deferredActionQueue._getDebugInfo(this$1.DEBUG); })
              };
          }
          return undefined;
      };
