...
var TEMPLATE = precompileTemplate("<div class=\"liquid-container {{@class}}\" ...attributes {{this.setup}}>\n	{{~yield this~}}\n</div>");

var _dec, _class, _descriptor;
let LiquidContainerComponent = (_dec = inject('liquid-fire-transitions'), (_class = class LiquidContainerComponent extends Component {
  constructor(...args) {
    super(...args);
    _initializerDefineProperty(this, "transitionMap", _descriptor, this);
    _defineProperty(this, "_wasInserted", false);
    _defineProperty(this, "element", null);
    _defineProperty(this, "_didSetup", false);
    _defineProperty(this, "setup", modifier(element => {
      if (this._didSetup) {
        return;
      }
      this._didSetup = true;
  ...
  writable: true,
  initializer: null
}), _applyDecoratedDescriptor(_class.prototype, "willTransition", [action], Object.getOwnPropertyDescriptor(_class.prototype, "willTransition"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "afterChildInsertion", [action], Object.getOwnPropertyDescriptor(_class.prototype, "afterChildInsertion"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "afterTransition", [action], Object.getOwnPropertyDescriptor(_class.prototype, "afterTransition"), _class.prototype)), _class));
...
setComponentTemplate(TEMPLATE, LiquidContainerComponent);

export { LiquidContainerComponent as default };
//# sourceMappingURL=liquid-container.js.map
