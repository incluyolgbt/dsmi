...
let LiquidVersionsComponent = (_dec = inject('liquid-fire-transitions'), (_class = class LiquidVersionsComponent extends Component {
  constructor(...args) {
    ...
    _initializerDefineProperty(this, "_versions", _descriptor2, this);
    _defineProperty(this, "__versions", null);
    _defineProperty(this, "appendVersion", modifier(() => {
  ...
  writable: true,
  initializer: null
}), _descriptor2 = _applyDecoratedDescriptor(_class.prototype, "_versions", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
...
}), _applyDecoratedDescriptor(_class.prototype, "childDidRender", [action], Object.getOwnPropertyDescriptor(_class.prototype, "childDidRender"), _class.prototype)), _class));
// equality.
