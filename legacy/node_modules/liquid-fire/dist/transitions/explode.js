...
function animationFor(context, piece) {
  ...
  return function () {
    return Promise$1.resolve(func.apply(this, args));
  };
}
...
function matchAndExplode(context, piece, seen) {
  ...
  const hits = A([...context.oldElement.querySelectorAll(`[${piece.matchBy}]`)]);
  return Promise$1.all(hits.map(elt => {
